...
public class RecyclerViewUpRefresh extends RecyclerView {
    ...
    //到底了
    public void loadMoreEnd(boolean isShowText) {
        if (loadingMoreFooter != null) {
            loadingMoreFooter.setEnd(isShowText);
        }
        isEnd = true;
    }
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && loadMoreListener != null
                && !isLoadingData && canloadMore && !isEnd) {
